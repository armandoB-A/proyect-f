...
export const DatosProd=()=>{
    ...
    const alumnos=[{id:"123", precio:"32", career:"PEPERONI", imageUrl:"atlas1q.jpg"}]
                        ...
                        <ModalBody classprecio="fondoM">
                            ...
                            <label>
                                ...
                                <select id={"inputs"} value={career} onChange={handleCareerChange}>
                                    <option value={"ISIC"}>PEPERONI</option>
                                    <option value={"Quimica"}>CARNES FRIAS</option>
                                    <option value={"TICs"}>QUESO</option>
                                    <option value={"Civil"}>AWAYANA</option>
                                </select>
                            </label>
                        </ModalBody>
